...
export const InputStandard = () => (
  <div className="w-full max-w-sm">
    ...
    <input 
      ...
      className="w-full px-4 py-2 bg-[hsl(var(--background))] border border-[hsl(var(--border))] rounded-lg text-sm shadow-sm placeholder-slate-400 text-[hsl(var(--foreground))]
...
export const InputFloatingLabel = () => (
  <div className="relative w-full max-w-sm">
    ...
    <label 
      ...
      className="absolute text-sm text-gray-500 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-[hsl(var(--background))] px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1"
    >
      Floating Label
    </label>
  </div>
...
export const InputUnderline = () => (
  <div className="w-full max-w-sm relative group">
    <input 
      ...
      className="w-full py-3 bg-transparent border-b-2 border-gray-300 text-[hsl(var(--foreground))] placeholder-transparent focus:outline-none peer"
    />
    <label 
...
export const InputSearchPill = () => (
  <div className="w-full max-w-sm relative">
    ...
    <input 
      type="search" 
      placeholder="Search..." 
      className="block w-full p-4 pl-10 text-sm text-[hsl(var(--foreground))] border border-[hsl(var(--border))] rounded-full bg-[hsl(var(--background))] focus:ring-blue-500 focus:border-blue-500 shadow-sm hover:shadow-md transition-all duration-300 outline-none" 
    />
...
export const InputGradientBorder = () => (
  <div className="w-full max-w-sm p-[2px] rounded-lg bg-gradient-to-r from-teal-400 via-blue-500 to-purple-600">
    <input 
      ...
      className="w-full px-4 py-2 rounded-md bg-[hsl(var(--background))] text-[hsl(var(--foreground))] focus:outline-none placeholder-gray-400"
    />
  </div>
);
...
const Inputs = () => {
  return (
    <div className="container bg-transparent p-6 md:p-12 font-sans pb-40 overflow-y-auto">
      <h1 className="text-3xl font-bold text-center text-[hsl(var(--foreground))] mb-12">Modern Input Fields</h1>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 max-w-7xl mx-auto justify-items-center">

        {/* 1. Standard */}
        <div className="w-full flex flex-col items-center glass-card p-6 rounded-xl relative group/input">

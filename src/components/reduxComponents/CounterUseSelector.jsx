  ...
  return (
    <div>
          <div className='flex flex-col justify-center items-center p-2 text-white '>
              <div>
                    <p className='text-2xl font-bold text-[hsl(var(--foreground))] my-6 glass-card rounded-md px-6 py-2'> {count ?? 0} </p>
              </div>
              <div>
              ...
              <div>
                  ...
                  
                  {
                      enablePostFetch === false ? (
                          <p className='italic mt-4 text-[hsl(var(--foreground))] opacity-60 my-10 animate-fade-in-up'>Post data is disabled.</p>
                      ) : null
                  }

...
const ThankYouGallery = () => {
  return (
    <div className="container box-shadow overflow-y-auto bg-slate-100 p-6 md:p-12 font-sans pb-40">
      ...
      <div className="space-y-32 max-w-6xl mx-auto">
        ...
        <section className='box-shadow p-4 rounded-lg relative group/than'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/than:opacity-100 transition-opacity"><CopyButton jsxCode={`<svg className="w-16 h-16 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>`} htmlCode={`<svg class="w-16 h-16 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>`} cssCode={`/* CheckBadge Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 01. Referral Boost </span>
          <ConfirmedReferral />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/than'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/than:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="flex flex-col md:flex-row h-[600px] bg-white rounded-3xl overflow-hidden border border-gray-200 shadow-sm">
    <div className="md:w-1/2 p-12 flex flex-col justify-center bg-gray-50">
      <h2 className="text-2xl font-bold text-gray-900 mb-4">Order #9921 Confirmed</h2>
      <div className="space-y-4 mb-8">
        <div className="flex gap-4">
  ...
  </div>`} htmlCode={`<div class="flex flex-col md:flex-row h-[600px] bg-white rounded-3xl overflow-hidden border border-gray-200 shadow-sm">
    <div class="md:w-1/2 p-12 flex flex-col justify-center bg-gray-50">
      <h2 class="text-2xl font-bold text-gray-900 mb-4">Order #9921 Confirmed</h2>
      <div class="space-y-4 mb-8">
        <div class="flex gap-4">
          <div class="w-16 h-16 bg-white border border-gray-200 rounded-lg p-2">
            <img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?q=80&w=200" class="w-full h-full object-contain" alt="" />
          </div>
          <div>
            <div class="font-bold text-gray-900">Nike Air Max</div>
            <div class="text-sm text-gray-500">Size 10 • Qty 1</div>
          </div>
        </div>
      </div>
      <div class="text-sm text-gray-500">
        Estimated Delivery: <span class="font-bold text-gray-900">Oct 28 - Oct 30</span>
      </div>
    </div>

    <div class="md:w-1/2 p-12 flex flex-col justify-center relative">
      <div class="absolute top-6 right-6">
        <button class="text-sm text-gray-400 hover:text-gray-600">Skip step</button>
      </div>
      <h3 class="text-2xl font-bold text-gray-900 mb-2">Save your information?</h3>
      <p class="text-gray-500 mb-8">Create an account to track your order, save your address, and checkout faster next time.</p>
      
      <form class="space-y-4">
        <div>
          <label class="text-xs font-bold uppercase text-gray-500 mb-1 block">Set a Password</label>
          <input type="password" placeholder="Min 8 characters" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-black outline-none" />
        </div>
        <button class="w-full py-3 bg-black text-white font-bold rounded-lg hover:bg-gray-800 transition-colors">
          Create Account
        </button>
      </form>
    </div>
  </div>`} cssCode={`/* ConfirmedAccount Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>
        ...
        <section className='box-shadow p-4 rounded-lg relative group/than'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/than:opacity-100 transition-opacity"><CopyButton jsxCode={`<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>`} htmlCode={`<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>`} cssCode={`/* CalendarIcon Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>
        ...
        <section className='box-shadow p-4 rounded-lg relative group/than'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/than:opacity-100 transition-opacity"><CopyButton jsxCode={`<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>`} htmlCode={`<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>`} cssCode={`/* DownloadIcon Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>
        ...
        <section className='box-shadow p-4 rounded-lg relative group/than'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/than:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-white p-10 rounded-3xl border border-gray-100 max-w-md mx-auto text-center overflow-hidden relative">
    {/* Confetti (Simulated) */}
    <div className="absolute top-10 left-10 w-2 h-2 bg-red-400 rounded-full"></div>
    <div className="absolute top-20 right-20 w-3 h-3 bg-blue-400 rotate-45"></div>
    <div className="absolute bottom-20 left-1/3 w-2 h-2 bg-yellow-400 rounded-full"></div>
    ...
    <button className="text-gray-500 font-medium hover:text-gray-900 text-sm">View Order Details</button>
  </div>`} htmlCode={`<div class="bg-white p-10 rounded-3xl border border-gray-100 max-w-md mx-auto text-center overflow-hidden relative">
    ...
    <div class="absolute top-10 left-10 w-2 h-2 bg-red-400 rounded-full"></div>
    <div class="absolute top-20 right-20 w-3 h-3 bg-blue-400 rotate-45"></div>
    <div class="absolute bottom-20 left-1/3 w-2 h-2 bg-yellow-400 rounded-full"></div>

    <div class="w-24 h-24 bg-yellow-100 rounded-full flex items-center justify-center mx-auto mb-6 text-4xl">
      🎉
    </div>
    
    <h2 class="text-2xl font-bold text-gray-900 mb-2">Payment Successful!</h2>
    
    <div class="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl p-6 text-white mb-8 mt-6 shadow-lg shadow-indigo-200">
      <div class="text-xs font-bold uppercase opacity-80 mb-1">You earned</div>
      <div class="text-4xl font-bold mb-4">150 Points</div>
      
      <div class="w-full bg-black/20 h-2 rounded-full mb-2 overflow-hidden">
        <div class="w-3/4 h-full bg-yellow-400"></div>
      </div>
    ...
    <button class="text-gray-500 font-medium hover:text-gray-900 text-sm">View Order Details</button>
  </div>`} cssCode={`/* ConfirmedLoyalty Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 05. Loyalty Reward </span>
          <ConfirmedLoyalty />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/than'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/than:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-white p-8 rounded-3xl border border-gray-200 max-w-xl mx-auto shadow-sm">
    <div className="flex items-center gap-4 border-b border-gray-100 pb-6 mb-6">
      <div className="w-12 h-12 bg-green-100 text-green-600 rounded-full flex items-center justify-center">✓</div>
      <div>
        <h2 className="text-lg font-bold text-gray-900">Order Placed</h2>
  ...
  </div>`} htmlCode={`<div class="bg-white p-8 rounded-3xl border border-gray-200 max-w-xl mx-auto shadow-sm">
    <div class="flex items-center gap-4 border-b border-gray-100 pb-6 mb-6">
      <div class="w-12 h-12 bg-green-100 text-green-600 rounded-full flex items-center justify-center">✓</div>
      <div>
        <h2 class="text-lg font-bold text-gray-900">Order Placed</h2>
        <p class="text-sm text-gray-500">Order #8821 confirmed.</p>
      </div>
    </div>
    
    <div class="text-center">
      <h3 class="font-bold text-gray-900 mb-4">How was your shopping experience?</h3>
      <div class="flex justify-center gap-2 mb-6">
        <!-- Mapping Start -->
(
          <button key=... class="text-3xl text-gray-300 hover:text-yellow-400 hover:scale-110 transition-all">★</button>
        ))}
      </div>
      <textarea 
        placeholder="Tell us what you liked or how we can improve..." 
        class="w-full p-4 bg-gray-50 rounded-xl border border-gray-200 text-sm focus:outline-none focus:border-gray-400 resize-none mb-4"
        rows="3"
      ></textarea>
      <button class="px-8 py-2 bg-gray-900 text-white rounded-lg text-sm font-bold hover:bg-gray-800 transition-colors">
        Submit Feedback
      </button>
    </div>
  </div>`} cssCode={`/* ConfirmedFeedback Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 06. Feedback Loop </span>
          <ConfirmedFeedback />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/than'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/than:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="flex flex-col md:flex-row h-[500px] bg-orange-50 rounded-3xl overflow-hidden border border-orange-100">
    <div className="md:w-1/2 p-12 flex flex-col justify-center">
      <h2 className="text-3xl font-bold text-gray-900 mb-4">Track your food in real-time</h2>
      <p className="text-gray-600 mb-8">
        Your order is being prepared. Download our app to track your rider on the map and get instant notifications.
  ...
  </div>`} htmlCode={`<div class="flex flex-col md:flex-row h-[500px] bg-orange-50 rounded-3xl overflow-hidden border border-orange-100">
    <div class="md:w-1/2 p-12 flex flex-col justify-center">
      <h2 class="text-3xl font-bold text-gray-900 mb-4">Track your food in real-time</h2>
      <p class="text-gray-600 mb-8">
        Your order is being prepared. Download our app to track your rider on the map and get instant notifications.
      </p>
      
      <div class="flex gap-4">
        <div class="w-32 h-32 bg-white p-2 rounded-xl shadow-sm">
          <img src="https://bwipjs-api.metafloor.com/?bcid=qrcode&text=DOWNLOAD_APP&scale=4" alt="QR" class="w-full h-full mix-blend-multiply" />
        </div>
        <div class="flex flex-col justify-center gap-2">
          <button class="bg-black text-white px-4 py-2 rounded-lg text-xs font-bold text-left">App Store</button>
          <button class="bg-black text-white px-4 py-2 rounded-lg text-xs font-bold text-left">Google Play</button>
        </div>
      </div>
    </div>
    
    <div class="md:w-1/2 relative bg-orange-100">
      <img src="https://images.unsplash.com/photo-1512428559087-560fa0db79b6?q=80&w=600&auto=format&fit=crop" class="absolute inset-0 w-full h-full object-cover mix-blend-multiply opacity-50" alt="Phone" />
      <div class="absolute bottom-0 left-1/2 -translate-x-1/2 w-48 h-80 bg-black rounded-t-3xl border-x-4 border-t-4 border-black shadow-2xl">
        <div class="w-full h-full bg-white rounded-t-[1.3rem] p-4 pt-12 text-center">
           <div class="w-12 h-12 bg-orange-500 rounded-full mx-auto mb-4 animate-bounce"></div>
           <div class="font-bold text-sm">Rider Nearby</div>
        </div>
      </div>
    </div>
  </div>`} cssCode={`/* ConfirmedApp Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 07. Mobile App Push </span>
          <ConfirmedApp />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/than'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/than:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-white p-12 rounded-none border border-gray-200 shadow-xl max-w-3xl mx-auto font-mono text-sm relative">
    {/* Paper tearing effect top */}
    <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-b from-gray-100 to-white"></div>
  ...
  </div>`} htmlCode={`<div class="bg-white p-12 rounded-none border border-gray-200 shadow-xl max-w-3xl mx-auto font-mono text-sm relative">
    ...
    ...
    <div class="flex justify-between items-start mb-12">
      ...
      <div class="text-right">
        <div class="font-bold">ACME Corp.</div>
        <div>123 Business Rd.</div>
        <div>New York, NY</div>
      </div>
    </div>
    ...
    <div class="border-t border-b border-gray-200 py-4 mb-8">
      <div class="grid grid-cols-4 font-bold mb-2">
        <div class="col-span-2">Item</div>
        <div class="text-right">Qty</div>
        <div class="text-right">Price</div>
      </div>
      <div class="grid grid-cols-4 text-gray-600">
        <div class="col-span-2">SaaS Enterprise License</div>
        <div class="text-right">1</div>
        <div class="text-right">\$499.00</div>
      </div>
    </div>
    ...
    <div class="text-center">
      <button class="text-blue-600 hover:underline print:hidden flex items-center justify-center gap-2 mx-auto">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" /></svg>
        Print Receipt
      </button>
    </div>
  </div>`} cssCode={`/* ConfirmedInvoice Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>
        ...
        <section className='box-shadow p-4 rounded-lg relative group/than'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/than:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-gradient-to-br from-pink-50 to-purple-50 p-12 rounded-3xl border border-purple-100 text-center max-w-lg mx-auto">
    <h2 className="text-3xl font-bold text-gray-900 mb-2">You have great taste!</h2>
    <p className="text-gray-500 mb-8">Your order is confirmed. Why not show it off?</p>
  ...
  </div>`} htmlCode={`<div class="bg-gradient-to-br from-pink-50 to-purple-50 p-12 rounded-3xl border border-purple-100 text-center max-w-lg mx-auto">
    <h2 class="text-3xl font-bold text-gray-900 mb-2">You have great taste!</h2>
    <p class="text-gray-500 mb-8">Your order is confirmed. Why not show it off?</p>
    
    <div class="bg-white p-4 rounded-2xl shadow-xl rotate-2 hover:rotate-0 transition-transform duration-300 mb-8 max-w-xs mx-auto">
      <div class="aspect-square bg-gray-100 rounded-xl overflow-hidden mb-4">
        <img src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?q=80&w=400&auto=format&fit=crop" class="w-full h-full object-cover" alt="Product" />
      </div>
      <div class="font-bold text-left">Limited Edition Watch</div>
      <div class="text-sm text-gray-500 text-left">Just bought on Brand.com 🔥</div>
    </div>
    
    <div class="flex justify-center gap-4">
      <button class="p-3 bg-white rounded-full shadow-sm hover:text-pink-600 hover:shadow-md transition-all">
        Instagram
      </button>
      <button class="p-3 bg-white rounded-full shadow-sm hover:text-blue-400 hover:shadow-md transition-all">
        Twitter
      </button>
      <button class="p-3 bg-white rounded-full shadow-sm hover:text-blue-600 hover:shadow-md transition-all">
        Facebook
      </button>
    </div>
  </div>`} cssCode={`/* ConfirmedSocial Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 09. Social Share </span>
          <ConfirmedSocial />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/than'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/than:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-white p-12 rounded-3xl border border-gray-100 max-w-4xl mx-auto">
    <div className="text-center mb-12">
      <h2 className="text-3xl font-bold text-gray-900 mb-2">Welcome to the Club!</h2>
      <p className="text-gray-500">Your membership is active. Here is what to do next:</p>
    </div>
  ...
  </div>`} htmlCode={`<div class="bg-white p-12 rounded-3xl border border-gray-100 max-w-4xl mx-auto">
    <div class="text-center mb-12">
      <h2 class="text-3xl font-bold text-gray-900 mb-2">Welcome to the Club!</h2>
      <p class="text-gray-500">Your membership is active. Here is what to do next:</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...,
        ...
        <div key=... class="bg-gray-50 p-6 rounded-2xl border border-gray-100 flex flex-col items-center text-center">
          <div class="w-12 h-12 bg-white rounded-full shadow-sm flex items-center justify-center text-2xl mb-4">
            ...
          </div>
          <h3 class="font-bold text-gray-900 mb-2">...</h3>
          <p class="text-sm text-gray-500 mb-6">...</p>
          <button class="mt-auto w-full py-2 bg-white border border-gray-200 rounded-lg text-sm font-bold hover:bg-gray-100 transition-colors">
            ...
          </button>
        </div>
      ))}
    </div>
  </div>`} cssCode={`/* ConfirmedOnboarding Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>

...
const FeatureGallery = () => {
  return (
    <div className="container box-shadow overflow-y-auto bg-slate-100 p-6 md:p-12 font-sans pb-40">
      ...
      <div className="space-y-32 max-w-7xl mx-auto">
        ...
        <section className='box-shadow p-4 rounded-lg relative group/feat'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/feat:opacity-100 transition-opacity"><CopyButton jsxCode={`<svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>`} htmlCode={`<svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>`} cssCode={`/* FeatureStandard Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  background-color: #dbeafe;\n  background-color: #e5e7eb;\n  background-color: #eff6ff;\n  background-color: #f3f4f6;\n  background-color: #f9fafb;\n  background-color: #ffffff;\n  border-color: #f3f4f6;\n  border-radius: 0.5rem;\n  border-radius: 0.75rem;\n  border-radius: 1.5rem;\n  border-radius: 1rem;\n  border-radius: 9999px;\n  border-width: 1px; border-style: solid;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #111827;\n  color: #16a34a;\n  color: #2563eb;\n  color: #374151;\n  color: #6b7280;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  justify-content: center;\n  padding: 1.5rem;\n  padding: 2rem;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 01. Classic Zig-Zag </span>
          <FeatureStandard />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/feat'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/feat:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-gray-50 p-8 rounded-3xl">
    <div className="text-center mb-12">
      <h2 className="text-3xl font-bold text-gray-900">Everything you need</h2>
      <p className="text-gray-500 mt-2">Powerful features wrapped in a beautiful interface.</p>
    </div>
  ...
  </div>`} htmlCode={`<div class="bg-gray-50 p-8 rounded-3xl">
    <div class="text-center mb-12">
      <h2 class="text-3xl font-bold text-gray-900">Everything you need</h2>
      <p class="text-gray-500 mt-2">Powerful features wrapped in a beautiful interface.</p>
    </div>
    
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
      ...
      <div class="md:col-span-2 bg-white rounded-3xl p-8 border border-gray-200 shadow-sm relative overflow-hidden h-64 md:h-auto min-h-[250px]">
        <h3 class="text-xl font-bold mb-2 relative z-10">Global Analytics</h3>
        <p class="text-gray-500 text-sm relative z-10">Track users from anywhere in real-time.</p>
        <div class="absolute right-0 bottom-0 w-2/3 h-2/3 bg-gradient-to-tl from-blue-50 to-transparent rounded-tl-[3rem] border-t border-l border-blue-100 flex items-end justify-end p-6">
           <div class="w-full h-full bg-white rounded-2xl shadow-md p-4">
              <div class="flex gap-2 items-end h-full justify-around">
                 <!-- Mapping Start -->
(
                   <div key=... class="w-4 bg-blue-500 rounded-t-sm" style=...%\`}}></div>
                 ))}
              </div>
           </div>
        </div>
      ...
      ...
      <div class="md:row-span-2 bg-white rounded-3xl p-8 border border-gray-200 shadow-sm flex flex-col items-center text-center">
        <div class="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mb-6 text-2xl">🔒</div>
        <h3 class="text-xl font-bold mb-2">Secure</h3>
        <p class="text-gray-500 text-sm">Enterprise-grade encryption for your data.</p>
      </div>

      ...
      <div class="bg-white rounded-3xl p-8 border border-gray-200 shadow-sm">
        <h3 class="text-xl font-bold mb-2">Fast</h3>
        <p class="text-gray-500 text-sm">Built on edge networks.</p>
      </div>

      ...
      <div class="bg-white rounded-3xl p-8 border border-gray-200 shadow-sm">
        <h3 class="text-xl font-bold mb-2">Team</h3>
        <p class="text-gray-500 text-sm">Collaborate instantly.</p>
      </div>
    </div>
  </div>`} cssCode={`/* FeatureBento Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  background-color: #3b82f6;\n  background-color: #f9fafb;\n  background-color: #ffffff;\n  border-color: #dbeafe;\n  border-color: #e5e7eb;\n  border-radius: 1.5rem;\n  border-radius: 1rem;\n  border-radius: 9999px;\n  border-width: 1px; border-style: solid;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #111827;\n  color: #6b7280;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  height: 100%;\n  justify-content: center;\n  padding: 1.5rem;\n  padding: 1rem;\n  padding: 2rem;\n  text-align: center;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 02. Bento Grid </span>
          <FeatureBento />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/feat'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/feat:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-white p-8 rounded-3xl border border-gray-100">
      <div className="grid md:grid-cols-12 gap-8">
        {/* Left: Tabs */}
        <div className="md:col-span-4 flex flex-col gap-4">
          {features.map((feat, i) => (
          ...
          )`} htmlCode={`<div class="bg-white p-8 rounded-3xl border border-gray-100">
...
(
            <button
              key=...
              onClick=...
              class=text-left p-6 rounded-2xl transition-all duration-300 border \$...
            >
          ...
          )`} cssCode={`/* FeatureTabs Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  background-color: #f3f4f6;\n  background-color: #ffffff;\n  border-color: #f3f4f6;\n  border-radius: 1.5rem;\n  border-width: 1px; border-style: solid;\n  color: #6b7280;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  padding: 2rem;\n  text-align: center;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
        ...
        <section className='box-shadow p-4 rounded-lg relative group/feat'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/feat:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-[#0d1117] text-white p-8 rounded-3xl border border-gray-800 overflow-hidden relative">
    <div className="relative z-10 flex flex-col md:flex-row items-center gap-12">
      <div className="w-full md:w-1/2">
        <div className="text-green-400 font-mono text-xs mb-4">\$\$ API_FIRST_PLATFORM</div>
        <h2 className="text-3xl font-bold mb-4">Built for developers,<br/> by developers.</h2>
  ...
  </div>`} htmlCode={`<div class="bg-[#0d1117] text-white p-8 rounded-3xl border border-gray-800 overflow-hidden relative">
    <div class="relative z-10 flex flex-col md:flex-row items-center gap-12">
      <div class="w-full md:w-1/2">
        <div class="text-green-400 font-mono text-xs mb-4">\$\$ API_FIRST_PLATFORM</div>
        <h2 class="text-3xl font-bold mb-4">Built for developers,<br/> by developers.</h2>
        <p class="text-gray-400 mb-8 leading-relaxed">
          Integrate our SDK in minutes. Comprehensive documentation, typed SDKs, and 99.99% uptime SLA.
        </p>
        <div class="flex gap-4">
          <button class="bg-white text-black px-6 py-2 rounded font-bold text-sm hover:bg-gray-200">Read Docs</button>
          <button class="bg-transparent border border-gray-700 text-white px-6 py-2 rounded font-bold text-sm hover:border-gray-500">Get API Key</button>
        </div>
      </div>
      
      <div class="w-full md:w-1/2">
        <div class="bg-[#161b22] rounded-xl border border-gray-700 shadow-2xl overflow-hidden">
          <div class="flex items-center px-4 py-2 border-b border-gray-700 bg-[#0d1117]">
            <div class="flex gap-1.5">
              <div class="w-3 h-3 rounded-full bg-red-500"></div>
              <div class="w-3 h-3 rounded-full bg-yellow-500"></div>
              <div class="w-3 h-3 rounded-full bg-green-500"></div>
            </div>
            <span class="ml-4 text-xs text-gray-500 font-mono">index.ts</span>
          </div>
          <div class="p-4 font-mono text-xs md:text-sm text-gray-300">
            <p><span class="text-purple-400">import</span> ... <span class="text-purple-400">from</span> <span class="text-green-300">'@sdk/core'</span>;</p>
            <br/>
            <p><span class="text-blue-400">const</span> client = <span class="text-purple-400">new</span> Client(...);</p>
            <br/>
            <p><span class="text-blue-400">await</span> client.users.<span class="text-yellow-200">create</span>(...);</p> */}
          </div>
        </div>
      </div>
    </div>
  </div>`} cssCode={`/* FeatureDev Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  background-color: #22c55e;\n  background-color: #eab308;\n  background-color: #ef4444;\n  background-color: #ffffff;\n  background-color: transparent;\n  border-color: #1f2937;\n  border-color: #374151;\n  border-radius: 0.75rem;\n  border-radius: 1.5rem;\n  border-radius: 9999px;\n  border-width: 1px; border-style: solid;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #000000;\n  color: #60a5fa;\n  color: #6b7280;\n  color: #9ca3af;\n  color: #c084fc;\n  color: #ffffff;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  padding-left: 1.5rem; padding-right: 1.5rem;\n  padding-left: 1rem; padding-right: 1rem;\n  padding-top: 0.5rem; padding-bottom: 0.5rem;\n  padding: 1rem;\n  padding: 2rem;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 04. Code Block </span>
          <FeatureDev />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/feat'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/feat:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="relative bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 p-12 rounded-3xl overflow-hidden min-h-[400px] flex items-center">
    {/* Decorative Orbs */}
    <div className="absolute top-0 right-0 w-64 h-64 bg-cyan-400 rounded-full mix-blend-overlay filter blur-3xl opacity-50"></div>
    <div className="absolute bottom-0 left-0 w-64 h-64 bg-yellow-400 rounded-full mix-blend-overlay filter blur-3xl opacity-50"></div>
  ...
  </div>`} htmlCode={`<div class="relative bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 p-12 rounded-3xl overflow-hidden min-h-[400px] flex items-center">
    ...
    <div class="absolute top-0 right-0 w-64 h-64 bg-cyan-400 rounded-full mix-blend-overlay filter blur-3xl opacity-50"></div>
    <div class="absolute bottom-0 left-0 w-64 h-64 bg-yellow-400 rounded-full mix-blend-overlay filter blur-3xl opacity-50"></div>

    <div class="relative z-10 grid md:grid-cols-2 gap-12 items-center w-full">
      <div class="text-white">
        <h2 class="text-4xl font-bold mb-6 drop-shadow-md">Unleash Creativity</h2>
        <p class="text-white/80 text-lg mb-8">
          Tools that don't get in your way. Designed for the modern creator economy.
        </p>
        <button class="bg-white/20 backdrop-blur-md border border-white/40 text-white px-8 py-3 rounded-full hover:bg-white/30 transition-all">
          Explore Tools
        </button>
      </div>
      ...
      <div class="grid grid-cols-2 gap-4">
        <!-- Mapping Start -->
(
          <div key=... class=bg-white/10 backdrop-blur-xl border border-white/20 p-6 rounded-2xl shadow-lg \$...>
            <div class="w-10 h-10 bg-white/20 rounded-lg mb-4"></div>
            <div class="h-2 w-20 bg-white/40 rounded mb-2"></div>
            <div class="h-2 w-12 bg-white/20 rounded"></div>
          </div>
        ))}
      </div>
    </div>
  </div>`} cssCode={`/* FeatureGlass Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  backdrop-filter: blur(12px);\n  background-color: #facc15;\n  border-radius: 0.5rem;\n  border-radius: 1.5rem;\n  border-radius: 9999px;\n  border-width: 1px; border-style: solid;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #ffffff;\n  display: flex;\n  font-weight: 700;\n  padding-left: 2rem; padding-right: 2rem;\n  padding-top: 0.75rem; padding-bottom: 0.75rem;\n  padding: 3rem;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
    ...
    <div class="text-center max-w-2xl mx-auto mb-16">
      ...
      <p class="text-gray-500">We provide a comprehensive suite of tools to help you grow your business.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...,
        ...
        <div key=... class="p-6 rounded-2xl bg-gray-50 hover:bg-blue-50 transition-colors cursor-default group">
          <div class="text-3xl mb-4 group-hover:scale-110 transition-transform duration-300 inline-block">...</div>
          <h3 class="text-lg font-bold text-gray-900 mb-2">...</h3>
          <p class="text-gray-500 text-sm leading-relaxed">...</p>
        </div>
      ))}
    </div>
  </div>`} cssCode={`/* FeatureGrid Styles (Generated from Tailwind) */\n.component-root {\n  background-color: #f9fafb;\n  background-color: #ffffff;\n  border-color: #f3f4f6;\n  border-radius: 1.5rem;\n  border-radius: 1rem;\n  border-width: 1px; border-style: solid;\n  color: #111827;\n  color: #6b7280;\n  font-weight: 700;\n  padding: 1.5rem;\n  padding: 2rem;\n  text-align: center;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 06. Service Grid </span>
          <FeatureGrid />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/feat'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/feat:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-orange-50 p-8 rounded-3xl overflow-hidden">
    <div className="flex flex-col md:flex-row items-center gap-16 max-w-5xl mx-auto">
      <div className="w-full md:w-1/2">
        <div className="inline-block px-3 py-1 bg-orange-100 text-orange-600 rounded-full text-xs font-bold uppercase tracking-wide mb-6">
          Mobile First
  ...
  </div>`} htmlCode={`<div class="bg-orange-50 p-8 rounded-3xl overflow-hidden">
    <div class="flex flex-col md:flex-row items-center gap-16 max-w-5xl mx-auto">
      <div class="w-full md:w-1/2">
        <div class="inline-block px-3 py-1 bg-orange-100 text-orange-600 rounded-full text-xs font-bold uppercase tracking-wide mb-6">
          Mobile First
        </div>
        ...
        <div class="flex gap-4">
          <button class="bg-black text-white px-5 py-2 rounded-lg text-sm font-bold">App Store</button>
          <button class="bg-black text-white px-5 py-2 rounded-lg text-sm font-bold">Play Store</button>
        </div>
      </div>
      
      <div class="w-full md:w-1/2 flex justify-center">
        <div class="relative w-[280px] h-[550px] bg-gray-900 rounded-[3rem] border-[8px] border-gray-900 shadow-2xl overflow-hidden">
          ...
          <div class="w-full h-full bg-white relative">
            ...
            <div class="bg-orange-500 h-32 p-6 pt-12 text-white">
              <div class="text-xs opacity-80">Dashboard</div>
            ...
            ...
            <div class="absolute bottom-6 right-6 w-12 h-12 bg-orange-500 rounded-full shadow-lg flex items-center justify-center text-white font-bold text-xl">+</div>
          </div>
        </div>
      </div>
    </div>
  </div>`} cssCode={`/* FeatureApp Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  background-color: #000000;\n  background-color: #111827;\n  background-color: #e5e7eb;\n  background-color: #f97316;\n  background-color: #f9fafb;\n  background-color: #ffffff;\n  border-color: #111827;\n  border-radius: 0.5rem;\n  border-radius: 0.75rem;\n  border-radius: 1.5rem;\n  border-radius: 9999px;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #111827;\n  color: #4b5563;\n  color: #ffffff;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  height: 100%;\n  justify-content: center;\n  padding-left: 0.75rem; padding-right: 0.75rem;\n  padding-left: 1.25rem; padding-right: 1.25rem;\n  padding-top: 0.25rem; padding-bottom: 0.25rem;\n  padding-top: 0.5rem; padding-bottom: 0.5rem;\n  padding: 0.75rem;\n  padding: 1.5rem;\n  padding: 1rem;\n  padding: 2rem;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 07. Mobile App </span>
          <FeatureApp />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/feat'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/feat:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-yellow-400 p-8 rounded-3xl border-4 border-black">
    <div className="grid md:grid-cols-2 gap-8 items-center">
      <div className="bg-white border-4 border-black p-8 shadow-[8px_8px_0_0_#000]">
        <h2 className="text-5xl font-black uppercase mb-6 leading-none">
          Power.<br/>Speed.<br/>Control.
    ...
    <div class="grid md:grid-cols-2 gap-8 items-center">
      <div class="bg-white border-4 border-black p-8 shadow-[8px_8px_0_0_#000]">
        <h2 class="text-5xl font-black uppercase mb-6 leading-none">
          Power.<br/>Speed.<br/>Control.
        </h2>
        <p class="font-bold text-lg mb-8">
          No fancy animations. Just raw performance for power users.
        </p>
        <button class="bg-black text-white px-8 py-3 font-bold uppercase hover:bg-white hover:text-black border-4 border-transparent hover:border-black transition-colors">
          Get Access
        </button>
      </div>
      
      <div class="grid grid-cols-2 gap-4">
        ... class="bg-pink-500 border-4 border-black p-6 aspect-square flex items-center justify-center hover:-translate-y-1 hover:shadow-[4px_4px_0_0_#000] transition-all cursor-pointer">
            <span class="text-4xl font-black text-white">0...</span>
          </div>
        ))}
      </div>
    </div>
  </div>`} cssCode={`/* FeatureBrutalist Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  background-color: #000000;\n  background-color: #ec4899;\n  background-color: #facc15;\n  background-color: #ffffff;\n  border-color: #000000;\n  border-color: transparent;\n  border-radius: 1.5rem;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #ffffff;\n  display: flex;\n  font-weight: 700;\n  justify-content: center;\n  padding-left: 2rem; padding-right: 2rem;\n  padding-top: 0.75rem; padding-bottom: 0.75rem;\n  padding: 1.5rem;\n  padding: 2rem;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 08. Brutalist </span>
          <FeatureBrutalist />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/feat'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/feat:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-white p-8 rounded-3xl border border-gray-100 overflow-hidden">
    <div className="flex flex-col md:flex-row gap-12 max-w-6xl mx-auto">
      {/* Sticky Image Side */}
      <div className="w-full md:w-1/2 md:sticky md:top-10 h-fit">
        <div className="aspect-square bg-slate-900 rounded-3xl flex items-center justify-center relative overflow-hidden shadow-2xl">
  ...
  </div>`} htmlCode={`<div class="bg-white p-8 rounded-3xl border border-gray-100 overflow-hidden">
    <div class="flex flex-col md:flex-row gap-12 max-w-6xl mx-auto">
      ...
      <div class="w-full md:w-1/2 md:sticky md:top-10 h-fit">
        <div class="aspect-square bg-slate-900 rounded-3xl flex items-center justify-center relative overflow-hidden shadow-2xl">
           <div class="absolute inset-0 bg-gradient-to-br from-blue-600 to-purple-600 opacity-20"></div>
           <div class="text-white text-center p-8">
             <div class="text-6xl mb-4">🚀</div>
             <h3 class="text-2xl font-bold">Launch faster</h3>
           </div>
        </div>
      </div>
      
      ...
      <div class="w-full md:w-1/2 flex flex-col gap-24 py-12">
        ...,
          ...,
          ...
        ].map((item, i) => (
          <div key=...>
            <div class="text-blue-600 font-bold text-xl mb-2">0....</div>
            <h3 class="text-3xl font-bold text-gray-900 mb-4">...</h3>
            <p class="text-gray-500 text-lg leading-relaxed">...</p>
          </div>
        ))}
      </div>
    </div>
  </div>`} cssCode={`/* FeatureSticky Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  background-color: #0f172a;\n  background-color: #ffffff;\n  border-color: #f3f4f6;\n  border-radius: 1.5rem;\n  border-width: 1px; border-style: solid;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #111827;\n  color: #2563eb;\n  color: #6b7280;\n  color: #ffffff;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  justify-content: center;\n  padding-top: 3rem; padding-bottom: 3rem;\n  padding: 2rem;\n  text-align: center;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 09. Sticky Story </span>
          <FeatureSticky />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/feat'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/feat:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-[#e0e5ec] p-12 rounded-3xl">
    <div className="text-center mb-16">
      <h2 className="text-3xl font-bold text-gray-700">Soft UI Features</h2>
    </div>
    ...
    <div class="text-center mb-16">
      <h2 class="text-3xl font-bold text-gray-700">Soft UI Features</h2>
    </div>
    
    <div class="grid md:grid-cols-3 gap-12">
      <!-- Mapping Start -->
(
        <div key=... class="bg-[#e0e5ec] p-8 rounded-[30px] shadow-[20px_20px_60px_#bebebe,-20px_-20px_60px_#ffffff] flex flex-col items-center text-center transition-transform hover:-translate-y-2">
          <div class="w-20 h-20 bg-[#e0e5ec] rounded-full shadow-[inset_6px_6px_12px_#bebebe,inset_-6px_-6px_12px_#ffffff] mb-6 flex items-center justify-center text-2xl text-gray-600">
            ✨
          </div>
          <h3 class="text-xl font-bold text-gray-600 mb-3">...</h3>
          <p class="text-gray-500 text-sm">Experience the depth and softness of neumorphic design.</p>
        </div>
      ))}
    </div>
  </div>`} cssCode={`/* FeatureNeumorphic Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  border-radius: 1.5rem;\n  border-radius: 9999px;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #374151;\n  color: #4b5563;\n  color: #6b7280;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  justify-content: center;\n  padding: 2rem;\n  padding: 3rem;\n  text-align: center;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>

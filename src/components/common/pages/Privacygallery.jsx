  ...
  return (
    <div className="container box-shadow overflow-y-auto bg-slate-100 p-6 md:p-12 font-sans pb-40">
      ...
      <div className="space-y-32 max-w-6xl mx-auto">
        ...
        <section className='box-shadow p-4 rounded-lg relative group/priv'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/priv:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-white p-8 rounded-3xl border border-gray-100 flex flex-col md:flex-row gap-12 h-[600px] overflow-hidden">
    {/* Sidebar */}
    <div className="w-full md:w-1/4 flex-shrink-0 border-r border-gray-100 pr-6">
      <div className="sticky top-0">
        <div className="flex items-center gap-2 mb-8 text-blue-600">
    ...
    ...
    <div class="w-full md:w-1/4 flex-shrink-0 border-r border-gray-100 pr-6">
      <div class="sticky top-0">
        <div class="flex items-center gap-2 mb-8 text-blue-600">
          <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
          <span class="font-bold text-lg">Privacy Center</span>
        </div>
...
(
        ...
        <div class="mt-8 pt-8 border-t border-gray-100">
          <p class="text-xs text-gray-400">Last updated: Oct 2024</p>
        </div>
      </div>
    </div>
...
(
        ...
        <section className='box-shadow p-4 rounded-lg relative group/priv'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/priv:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-slate-50 p-8 rounded-3xl h-[600px] overflow-y-auto">
    <div className="max-w-5xl mx-auto">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold text-slate-900">Privacy Policy</h2>
        <p className="text-slate-500 mt-2">We value your trust. Here is how we protect your information.</p>
  ...
  </div>`} htmlCode={`<div class="bg-slate-50 p-8 rounded-3xl h-[600px] overflow-y-auto">
    <div class="max-w-5xl mx-auto">
      <div class="text-center mb-12">
        <h2 class="text-3xl font-bold text-slate-900">Privacy Policy</h2>
        <p class="text-slate-500 mt-2">We value your trust. Here is how we protect your information.</p>
      </div>

      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <!-- Mapping Start -->
(
          <div key=... class="bg-white p-8 rounded-2xl border border-gray-100 hover:shadow-lg transition-shadow">
            <div class="w-12 h-12 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center mb-6">
              ...
            </div>
            <h3 class="text-xl font-bold text-slate-900 mb-3">...</h3>
  ...
  </div>`} cssCode={`/* PrivacyCards Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 02. Card Grid </span>
          <PrivacyCards />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/priv'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/priv:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-white p-8 rounded-3xl border border-gray-100 h-[600px] overflow-y-auto">
      <div className="max-w-2xl mx-auto">
        <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Privacy Policy</h2>
      ...
      <div class="max-w-2xl mx-auto">
        <h2 class="text-3xl font-bold text-gray-900 mb-8 text-center">Privacy Policy</h2>
        
        <div class="space-y-4">
          <!-- Mapping Start -->
(
            <div key=... class=border rounded-xl overflow-hidden transition-all duration-300 \$...>
              <button 
                onClick=...
              ...
              <div class=transition-all duration-300 ease-in-out px-5 overflow-hidden \$...>
                <p class="text-gray-600 text-sm leading-relaxed">...</p>
              </div>
            </div>
          )`} cssCode={`/* PrivacyAccordion Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 03. Accordion </span>
          <PrivacyAccordion />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/priv'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/priv:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-[#fcfcfc] p-12 rounded-3xl h-[600px] overflow-y-auto border border-gray-200">
    <div className="max-w-2xl mx-auto">
      <h1 className="text-5xl font-serif text-black mb-4 tracking-tight">Privacy.</h1>
      <div className="flex justify-between items-center text-xs font-mono uppercase tracking-widest text-gray-400 mb-16 border-b border-gray-200 pb-4">
        <span>Effective: Jan 01, 2024</span>
  ...
  </div>`} htmlCode={`<div class="bg-[#fcfcfc] p-12 rounded-3xl h-[600px] overflow-y-auto border border-gray-200">
    <div class="max-w-2xl mx-auto">
      <h1 class="text-5xl font-serif text-black mb-4 tracking-tight">Privacy.</h1>
      <div class="flex justify-between items-center text-xs font-mono uppercase tracking-widest text-gray-400 mb-16 border-b border-gray-200 pb-4">
        <span>Effective: Jan 01, 2024</span>
        <span>Ver 2.1</span>
      </div>
      
      <div class="space-y-16 font-serif text-gray-800">
        <!-- Mapping Start -->
(
          <div key=...>
            <span class="block text-xs font-sans font-bold text-gray-300 mb-2">0...</span>
            <h3 class="text-2xl mb-4">...</h3>
            <p class="text-lg leading-relaxed text-gray-600">...</p>
          </div>
        ))}
      </div>
    </div>
  </div>`} cssCode={`/* PrivacyMinimal Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>
    ...
    <div class="max-w-3xl mx-auto">
      <div class="text-center mb-12">
        <h2 class="text-3xl font-bold text-gray-900">Your Data Journey</h2>
        <p class="text-gray-500">How data moves through our system.</p>
      </div>

      <div class="relative border-l-2 border-blue-100 ml-4 md:ml-12 pl-8 space-y-12">
        <!-- Mapping Start -->
(
          <div key=... class="relative">
            ...
            <div class="absolute -left-[41px] top-0 w-6 h-6 bg-white border-4 border-blue-500 rounded-full"></div>
            
            <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100 relative top-[-6px]">
  ...
  </div>`} cssCode={`/* PrivacyTimeline Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>
        ...
        <section className='box-shadow p-4 rounded-lg relative group/priv'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/priv:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="flex h-[600px] bg-slate-900 rounded-3xl overflow-hidden text-white">
    {/* Left Fixed */}
    <div className="w-1/3 bg-black p-12 flex flex-col justify-between border-r border-gray-800">
      <div>
        <div className="w-10 h-10 bg-green-500 rounded-lg flex items-center justify-center mb-6">
  ...
  </div>`} htmlCode={`<div class="flex h-[600px] bg-slate-900 rounded-3xl overflow-hidden text-white">
    ...
    <div class="w-1/3 bg-black p-12 flex flex-col justify-between border-r border-gray-800">
      <div>
        <div class="w-10 h-10 bg-green-500 rounded-lg flex items-center justify-center mb-6">
...
(
          <div key=...>
            <h3 class="text-green-400 font-mono text-sm mb-2">// SECTION 0\$...</h3>
            <h4 class="text-xl font-bold mb-3">...</h4>
  ...
  </div>`} cssCode={`/* PrivacySplit Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 06. Dark Mode Split </span>
          <PrivacySplit />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/priv'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/priv:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="relative h-[600px] rounded-3xl overflow-hidden bg-gradient-to-br from-teal-400 to-blue-500 flex items-center justify-center p-8">
    <div className="relative w-full max-w-3xl h-full bg-white/20 backdrop-blur-lg border border-white/30 rounded-3xl shadow-2xl flex flex-col overflow-hidden">
      <div className="p-8 border-b border-white/20">
        <h2 className="text-3xl font-bold text-white drop-shadow-sm">Privacy Policy</h2>
      </div>
  ...
  </div>`} htmlCode={`<div class="relative h-[600px] rounded-3xl overflow-hidden bg-gradient-to-br from-teal-400 to-blue-500 flex items-center justify-center p-8">
    <div class="relative w-full max-w-3xl h-full bg-white/20 backdrop-blur-lg border border-white/30 rounded-3xl shadow-2xl flex flex-col overflow-hidden">
      <div class="p-8 border-b border-white/20">
        <h2 class="text-3xl font-bold text-white drop-shadow-sm">Privacy Policy</h2>
      </div>
      
      <div class="p-8 overflow-y-auto text-white">
        <!-- Mapping Start -->
(
          <div key=... class="mb-8 p-6 bg-black/10 rounded-2xl border border-white/10 hover:bg-black/20 transition-colors">
            <h3 class="text-xl font-bold mb-3">...</h3>
            <p class="text-white/80 leading-relaxed font-medium">...</p>
          </div>
        ))}
      </div>
    </div>
  </div>`} cssCode={`/* PrivacyGlass Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 07. Glassmorphism </span>
          <PrivacyGlass />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/priv'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/priv:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-pink-500 p-8 rounded-3xl border-4 border-black h-[600px] flex flex-col">
    <div className="bg-white border-4 border-black p-6 mb-8 shadow-[8px_8px_0_0_#000]">
      <h1 className="text-5xl font-black uppercase">Your<br/>Data.</h1>
    </div>
  ...
  </div>`} htmlCode={`<div class="bg-pink-500 p-8 rounded-3xl border-4 border-black h-[600px] flex flex-col">
    <div class="bg-white border-4 border-black p-6 mb-8 shadow-[8px_8px_0_0_#000]">
      <h1 class="text-5xl font-black uppercase">Your<br/>Data.</h1>
    </div>
...
(
          <div key=... class="bg-white border-4 border-black p-6 hover:-translate-y-1 transition-transform">
            <h3 class="text-xl font-black uppercase mb-4 bg-yellow-400 inline-block px-2 border-2 border-black">
              ...
            </h3>
  ...
  </div>`} cssCode={`/* PrivacyBrutalist Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 08. Brutalist </span>
          <PrivacyBrutalist />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/priv'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/priv:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-[#e0e5ec] p-12 rounded-3xl h-[600px] overflow-y-auto">
    <div className="max-w-3xl mx-auto">
      <div className="text-center mb-12">
        <div className="w-20 h-20 bg-[#e0e5ec] rounded-full shadow-[5px_5px_10px_#bebebe,-5px_-5px_10px_#ffffff] flex items-center justify-center mx-auto mb-6 text-2xl text-gray-500">
          🛡️
    ...
    <div class="max-w-3xl mx-auto">
      <div class="text-center mb-12">
        ...
        <h2 class="text-3xl font-bold text-gray-700">Privacy Policy</h2>
      </div>
...
(
  ...
  </div>`} cssCode={`/* PrivacyNeumorphic Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 09. Neumorphic </span>
          <PrivacyNeumorphic />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/priv'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/priv:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-white p-12 rounded-3xl border border-gray-100 h-[600px] overflow-y-auto">
    <div className="max-w-3xl mx-auto">
      <h2 className="text-3xl font-bold text-gray-900 mb-2">Privacy & Data</h2>
      <p className="text-gray-500 mb-12">Common questions about how we handle your information.</p>
  ...
  </div>`} htmlCode={`<div class="bg-white p-12 rounded-3xl border border-gray-100 h-[600px] overflow-y-auto">
    <div class="max-w-3xl mx-auto">
      <h2 class="text-3xl font-bold text-gray-900 mb-2">Privacy & Data</h2>
      <p class="text-gray-500 mb-12">Common questions about how we handle your information.</p>
      
      <div class="grid gap-8">
        <!-- Mapping Start -->
(
          <div key=... class="flex gap-6 items-start">
            <div class="flex-shrink-0 w-10 h-10 bg-indigo-50 text-indigo-600 rounded-lg flex items-center justify-center font-bold">
              Q...
            </div>
            <div>
      ...
      <div class="mt-12 p-6 bg-gray-50 rounded-xl text-center">
        <p class="text-sm text-gray-600">Still have questions?</p>
        <a href="#" class="text-indigo-600 font-bold hover:underline">Contact our DPO</a>
      </div>
    </div>
  </div>`} cssCode={`/* PrivacyFAQ Component Styles */\n\n/* \n   This component is built using Tailwind CSS utility classes.\n   To use it as Vanilla CSS, you will need to: \n   1. Add tailwind.css to your project, OR\n   2. Convert these classes to standard CSS rules.\n*/\n\n.component-wrapper {\n  /* Add your custom styles here */\n}`} /></div>

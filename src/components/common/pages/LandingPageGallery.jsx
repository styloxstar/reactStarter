...
const LandingPageGallery = () => {
  return (
    <div className="container box-shadow overflow-y-auto bg-slate-100 p-6 md:p-12 font-sans pb-40">
      ...
      <div className="space-y-32">
        <section className='box-shadow p-4 rounded-lg relative group/land'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/land:opacity-100 transition-opacity"><CopyButton jsxCode={`<nav className={\`flex justify-between items-center py-6 \${dark ? 'text-white' : 'text-slate-900'}\`}>
    <div className="font-bold text-xl tracking-tight">Brand.</div>
    <div className="hidden md:flex gap-8 text-sm font-medium">
      <a href="#" className="hover:opacity-70">Product</a>
      <a href="#" className="hover:opacity-70">Features</a>
  ...
  </div>`} htmlCode={`<div class="bg-slate-900 text-white p-8 rounded-3xl overflow-hidden relative">
    ...
    <div class="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
      <div class="absolute -top-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-purple-600/30 blur-[100px]"></div>
      <div class="absolute top-[20%] right-[10%] w-[40%] h-[40%] rounded-full bg-blue-600/30 blur-[100px]"></div>
    </div>

    <div class="relative z-10 max-w-7xl mx-auto">
      <navbar dark ></navbar>
      <div class="grid md:grid-cols-2 gap-12 items-center mt-12 mb-20">
        <div>
          <h1 class="text-6xl font-bold leading-tight mb-6">
            Build the future <br/> of <span class="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">digital art.</span>
          </h1>
          <p class="text-slate-400 text-lg mb-8 leading-relaxed">
            Create, collect, and sell extraordinary NFTs. The world's first and largest digital marketplace for crypto collectibles.
          </p>
          <div class="flex flex-col sm:flex-row gap-4">
            <button class="px-8 py-3 bg-white text-slate-900 rounded-full font-bold hover:bg-gray-100">Explore</button>
            <button class="px-8 py-3 border border-slate-700 rounded-full font-bold hover:bg-slate-800">Create</button>
          </div>
          <div class="mt-12 flex gap-8 text-slate-500">
            <div><span class="block text-2xl font-bold text-white">98k+</span>Artworks</div>
            <div><span class="block text-2xl font-bold text-white">12k+</span>Auctions</div>
            <div><span class="block text-2xl font-bold text-white">15k+</span>Artists</div>
          </div>
        </div>
        <div class="relative">
          <div class="aspect-square rounded-2xl bg-gradient-to-br from-white/10 to-white/5 border border-white/10 backdrop-blur-md p-6 transform rotate-3 hover:rotate-0 transition-all duration-500">
             <div class="w-full h-full bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl shadow-2xl"></div>
          </div>
        </div>
      </div>
    </div>
  </div>`} cssCode={`/* LandingGradient Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  backdrop-filter: blur(12px);\n  background-color: #0f172a;\n  background-color: #ffffff;\n  border-color: #334155;\n  border-radius: 0.75rem;\n  border-radius: 1.5rem;\n  border-radius: 1rem;\n  border-radius: 9999px;\n  border-width: 1px; border-style: solid;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #0f172a;\n  color: #64748b;\n  color: #94a3b8;\n  color: #ffffff;\n  color: transparent;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  height: 100%;\n  padding-left: 2rem; padding-right: 2rem;\n  padding-top: 0.75rem; padding-bottom: 0.75rem;\n  padding: 1.5rem;\n  padding: 2rem;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 02. Modern Gradient </span>
          <LandingGradient />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/land'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/land:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-[#f4f4f0] p-8 rounded-3xl border border-stone-200">
    <nav className="flex justify-between items-center py-6 max-w-7xl mx-auto text-stone-900">
      <div className="font-serif font-bold text-2xl italic">Lumina.</div>
      <div className="hidden md:block text-sm uppercase tracking-widest font-bold">Architecture & Design</div>
      <button className="text-sm border-b border-stone-900 pb-1 hover:opacity-60 transition-opacity">Contact</button>
  ...
  </div>`} htmlCode={`<div class="bg-[#f4f4f0] p-8 rounded-3xl border border-stone-200">
    <nav class="flex justify-between items-center py-6 max-w-7xl mx-auto text-stone-900">
      <div class="font-serif font-bold text-2xl italic">Lumina.</div>
      <div class="hidden md:block text-sm uppercase tracking-widest font-bold">Architecture & Design</div>
      <button class="text-sm border-b border-stone-900 pb-1 hover:opacity-60 transition-opacity">Contact</button>
    </nav>
    
    <div class="max-w-7xl mx-auto mt-24 mb-32">
      <h1 class="text-[12vw] leading-[0.8] font-serif text-stone-900">
        Simplicity <br/>
        <span class="ml-24 italic text-stone-400">is the</span> <br/>
        ultimate form.
      </h1>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24">
        <div class="col-span-1">
          ...
          <button class="mt-8 px-8 py-3 bg-stone-900 text-[#f4f4f0] rounded-full text-sm uppercase tracking-wider hover:bg-stone-700 transition-colors">
            View Projects
          </button>
        </div>
        <div class="col-span-2 h-64 bg-stone-300 rounded-lg overflow-hidden relative">
           <img src="https://images.unsplash.com/photo-1600607686527-6fb886090705?q=80&w=1000&auto=format&fit=crop" class="w-full h-full object-cover grayscale opacity-80" alt="Minimal" />
        </div>
      </div>
    </div>
  </div>`} cssCode={`/* LandingMinimal Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  border-radius: 0.5rem;\n  border-radius: 1.5rem;\n  border-radius: 9999px;\n  border-width: 1px; border-style: solid;\n  display: flex;\n  font-weight: 700;\n  height: 100%;\n  justify-content: space-between;\n  padding-left: 2rem; padding-right: 2rem;\n  padding-top: 0.75rem; padding-bottom: 0.75rem;\n  padding-top: 1.5rem; padding-bottom: 1.5rem;\n  padding: 2rem;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
        ...
        <section className='box-shadow p-4 rounded-lg relative group/land'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/land:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-black text-white p-8 rounded-3xl border border-gray-800 font-mono">
    <div className="max-w-7xl mx-auto">
      <div className="flex justify-between items-center py-6 mb-16">
        <div className="text-green-500 font-bold">&lt;DevTools /&gt;</div>
        <div className="flex gap-6 text-xs text-gray-400">
  ...
  </div>`} htmlCode={`<div class="bg-black text-white p-8 rounded-3xl border border-gray-800 font-mono">
    <div class="max-w-7xl mx-auto">
      <div class="flex justify-between items-center py-6 mb-16">
        <div class="text-green-500 font-bold">&lt;DevTools /&gt;</div>
      ...
      <div class="grid md:grid-cols-2 gap-16 items-center">
        <div>
          <div class="inline-block px-3 py-1 bg-gray-900 text-green-400 rounded mb-6 text-xs">v4.0.2 Stable Release</div>
          <h1 class="text-5xl font-bold mb-6 tracking-tighter">
            Infrastructure for <br/>
            <span class="text-green-500">modern applications.</span>
          </h1>
          ...
          <div class="flex gap-4">
            <div class="relative">
              <input type="email" placeholder="email@company.com" class="bg-gray-900 border border-gray-700 text-white px-4 py-3 rounded w-64 focus:outline-none focus:border-green-500" />
            </div>
            <button class="bg-green-600 text-black px-6 py-3 rounded font-bold hover:bg-green-500 transition-colors">
              Deploy Now
            </button>
          </div>
        </div>
        ...
        ...
        <div class="bg-[#1e1e1e] rounded-xl border border-gray-800 shadow-2xl overflow-hidden">
          <div class="flex items-center gap-2 px-4 py-3 bg-[#252526] border-b border-gray-800">
            <div class="w-3 h-3 rounded-full bg-[#ff5f56]"></div>
            <div class="w-3 h-3 rounded-full bg-[#ffbd2e]"></div>
            <div class="w-3 h-3 rounded-full bg-[#27c93f]"></div>
            <span class="ml-2 text-xs text-gray-500">config.js</span>
          </div>
          <div class="p-6 text-sm text-gray-300 leading-relaxed overflow-x-auto">
            <p><span class="text-purple-400">import</span> ... <span class="text-purple-400">from</span> <span class="text-orange-300">'@devtools/sdk'</span>;</p>
            <p class="mt-2"><span class="text-blue-400">const</span> app = <span class="text-yellow-300">await</span> deploy(...</p>
            <p>});</p>
            <p class="mt-2 text-green-600 text-xs">// 🚀 Deployed in 450ms</p>
          </div>
        </div>
      </div>
    </div>
  </div>`} cssCode={`/* LandingDev Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  background-color: #000000;\n  background-color: #111827;\n  background-color: #16a34a;\n  border-color: #1f2937;\n  border-color: #374151;\n  border-radius: 0.75rem;\n  border-radius: 1.5rem;\n  border-radius: 9999px;\n  border-width: 1px; border-style: solid;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #000000;\n  color: #16a34a;\n  color: #22c55e;\n  color: #60a5fa;\n  color: #6b7280;\n  color: #9ca3af;\n  color: #c084fc;\n  color: #fde047;\n  color: #ffffff;\n  display: flex;\n  font-weight: 700;\n  justify-content: space-between;\n  padding-left: 0.75rem; padding-right: 0.75rem;\n  padding-left: 1.5rem; padding-right: 1.5rem;\n  padding-left: 1rem; padding-right: 1rem;\n  padding-top: 0.25rem; padding-bottom: 0.25rem;\n  padding-top: 0.75rem; padding-bottom: 0.75rem;\n  padding-top: 1.5rem; padding-bottom: 1.5rem;\n  padding: 1.5rem;\n  padding: 2rem;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
    ...
    <button class=px-5 py-2 rounded-full text-sm font-bold transition-all \$...>
      Get Started
  ...
  </nav>`} cssCode={`/* LandingMobile Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  backdrop-filter: blur(12px);\n  background-color: #000000;\n  background-color: #e5e7eb;\n  background-color: #f97316;\n  background-color: #f9fafb;\n  background-color: #fb923c;\n  background-color: #ffffff;\n  border-color: #000000;\n  border-radius: 0.75rem;\n  border-radius: 1.5rem;\n  border-radius: 9999px;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #0f172a;\n  color: #334155;\n  color: #475569;\n  color: #ffffff;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  height: 100%;\n  justify-content: center;\n  justify-content: space-between;\n  padding-left: 1.5rem; padding-right: 1.5rem;\n  padding-top: 0.75rem; padding-bottom: 0.75rem;\n  padding: 0.75rem;\n  padding: 1.5rem;\n  padding: 1rem;\n  padding: 2rem;\n  text-align: center;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
        ...
        <section className='box-shadow p-4 rounded-lg relative group/land'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/land:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-[#050505] text-white p-8 rounded-3xl border border-gray-900 relative overflow-hidden">
    {/* Grid Overlay */}
    <div className="absolute inset-0 bg-[linear-gradient(rgba(34,211,238,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(34,211,238,0.05)_1px,transparent_1px)] bg-[size:40px_40px]"></div>
  ...
  </div>`} htmlCode={`<div class="bg-[#050505] text-white p-8 rounded-3xl border border-gray-900 relative overflow-hidden">
    ...
    <div class="absolute inset-0 bg-[linear-gradient(rgba(34,211,238,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(34,211,238,0.05)_1px,transparent_1px)] bg-[size:40px_40px]"></div>
    
    <div class="relative z-10 max-w-7xl mx-auto">
      <nav class="flex justify-between items-center py-6 font-mono">
        <div class="text-cyan-400 font-bold tracking-widest text-xl">CYBER<span class="text-white">DEX</span></div>
        <button class="border border-cyan-500 text-cyan-400 px-6 py-2 hover:bg-cyan-500 hover:text-black transition-all uppercase tracking-widest text-xs font-bold">Connect Wallet</button>
      </nav>

      <div class="mt-20 text-center">
        <div class="inline-block border border-pink-500 text-pink-500 px-4 py-1 rounded-full text-xs font-mono mb-6 animate-pulse">
          LIVE ON MAINNET
        </div>
        <h1 class="text-6xl md:text-8xl font-black mb-6 uppercase italic tracking-tighter" style=...}>
          Decentralize <br/> Everything
        </h1>
        <p class="text-gray-400 font-mono max-w-xl mx-auto mb-10">
          Trade tokens, earn yield, and participate in governance. 
          The future of finance is open source and permissionless.
        </p>
        <div class="flex justify-center gap-4">
          <button class="bg-cyan-500 text-black px-8 py-4 font-bold uppercase tracking-widest hover:bg-cyan-400 hover:shadow-[0_0_20px_rgba(6,182,212,0.6)] transition-all clip-path-slant">
            Start Trading
          </button>
          <button class="bg-transparent border border-gray-600 text-gray-300 px-8 py-4 font-bold uppercase tracking-widest hover:border-white hover:text-white transition-all">
            Read Whitepaper
          </button>
        </div>
      </div>
      ...
      ...
      <div class="mt-32 border-t border-gray-800 pt-6 flex justify-between font-mono text-xs text-gray-500">
        <span>BTC: \$42,302</span>
        <span>ETH: \$2,450</span>
        <span>SOL: \$108</span>
        <span>GAS: 24 GWEI</span>
  ...
  </div>`} cssCode={`/* LandingCyber Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  background-color: transparent;\n  border-color: #111827;\n  border-color: #1f2937;\n  border-color: #4b5563;\n  border-color: #ec4899;\n  border-radius: 1.5rem;\n  border-radius: 9999px;\n  border-width: 1px; border-style: solid;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #000000;\n  color: #6b7280;\n  color: #9ca3af;\n  color: #ec4899;\n  color: #ffffff;\n  display: flex;\n  font-weight: 700;\n  justify-content: center;\n  justify-content: space-between;\n  padding-left: 1.5rem; padding-right: 1.5rem;\n  padding-left: 1rem; padding-right: 1rem;\n  padding-left: 2rem; padding-right: 2rem;\n  padding-top: 0.25rem; padding-bottom: 0.25rem;\n  padding-top: 0.5rem; padding-bottom: 0.5rem;\n  padding-top: 1.5rem; padding-bottom: 1.5rem;\n  padding-top: 1rem; padding-bottom: 1rem;\n  padding: 2rem;\n  text-align: center;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 06. Cyberpunk Web3 </span>
          <LandingCyber />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/land'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/land:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="relative h-[600px] w-full rounded-3xl overflow-hidden">
    <img src="https://images.unsplash.com/photo-1483985988355-763728e1935b?q=80&w=1000&auto=format&fit=crop" className="absolute inset-0 w-full h-full object-cover" alt="Fashion" />
    <div className="absolute inset-0 bg-black/30"></div>
  ...
  </div>`} htmlCode={`<div class="relative h-[600px] w-full rounded-3xl overflow-hidden">
    <img src="https://images.unsplash.com/photo-1483985988355-763728e1935b?q=80&w=1000&auto=format&fit=crop" class="absolute inset-0 w-full h-full object-cover" alt="Fashion" />
    <div class="absolute inset-0 bg-black/30"></div>
    
    <div class="relative z-10 h-full flex flex-col justify-between p-12 text-white">
      <nav class="flex justify-between items-center">
        <div class="text-2xl font-bold tracking-widest uppercase">VOGUE</div>
      ...
      <div class="max-w-xl">
        <span class="text-sm font-bold uppercase tracking-widest mb-4 block">Summer Collection 2024</span>
        <h1 class="text-6xl font-serif mb-6 leading-none">
          Elegance is <br/> elimination.
        </h1>
        <button class="bg-white text-black px-8 py-4 uppercase tracking-widest text-xs font-bold hover:bg-gray-200 transition-colors">
          Shop the look
        </button>
      </div>
    </div>
  </div>`} cssCode={`/* LandingFashion Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  background-color: #ffffff;\n  border-radius: 1.5rem;\n  color: #000000;\n  color: #ffffff;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  height: 100%;\n  justify-content: space-between;\n  padding-left: 2rem; padding-right: 2rem;\n  padding-top: 1rem; padding-bottom: 1rem;\n  padding: 3rem;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
        ...
        <section className='box-shadow p-4 rounded-lg relative group/land'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/land:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 p-8 rounded-3xl overflow-hidden relative min-h-[600px] flex items-center">
    {/* Background Shapes */}
    <div className="absolute top-20 left-20 w-64 h-64 bg-yellow-300 rounded-full mix-blend-overlay filter blur-3xl opacity-50 animate-blob"></div>
    <div className="absolute bottom-20 right-20 w-64 h-64 bg-cyan-300 rounded-full mix-blend-overlay filter blur-3xl opacity-50 animate-blob animation-delay-2000"></div>
  ...
  </div>`} htmlCode={`<div class="bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 p-8 rounded-3xl overflow-hidden relative min-h-[600px] flex items-center">
    ...
    <div class="absolute top-20 left-20 w-64 h-64 bg-yellow-300 rounded-full mix-blend-overlay filter blur-3xl opacity-50 animate-blob"></div>
    <div class="absolute bottom-20 right-20 w-64 h-64 bg-cyan-300 rounded-full mix-blend-overlay filter blur-3xl opacity-50 animate-blob animation-delay-2000"></div>
    ...
    <div class="relative z-10 max-w-4xl mx-auto text-center">
      <div class="bg-white/10 backdrop-blur-xl border border-white/20 p-12 rounded-[3rem] shadow-2xl">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4">
          <button class="px-8 py-4 bg-white/90 text-purple-600 rounded-full font-bold shadow-lg hover:scale-105 transition-transform">
            Start Creating
          </button>
          <button class="px-8 py-4 bg-transparent border-2 border-white text-white rounded-full font-bold hover:bg-white/20 transition-colors">
            Watch Showreel
          </button>
        </div>
      </div>
    </div>
  </div>`} cssCode={`/* LandingGlass Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  backdrop-filter: blur(12px);\n  background-color: #fde047;\n  background-color: transparent;\n  border-color: #ffffff;\n  border-radius: 1.5rem;\n  border-radius: 9999px;\n  border-width: 1px; border-style: solid;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #9333ea;\n  color: #ffffff;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  justify-content: center;\n  padding-left: 2rem; padding-right: 2rem;\n  padding-top: 1rem; padding-bottom: 1rem;\n  padding: 2rem;\n  padding: 3rem;\n  text-align: center;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
    ...
    <button class=px-5 py-2 rounded-full text-sm font-bold transition-all \$...>
      Get Started
  ...
  </nav>`} cssCode={`/* LandingBrutalist Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  background-color: #000000;\n  background-color: #ec4899;\n  background-color: #facc15;\n  background-color: #ffffff;\n  border-color: #000000;\n  border-radius: 1.5rem;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #ffffff;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  justify-content: center;\n  padding-left: 0.5rem; padding-right: 0.5rem;\n  padding: 1rem;\n  padding: 2rem;\n  padding: 3rem;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
        ...
        <section className='box-shadow p-4 rounded-lg relative group/land'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/land:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-[#e0e5ec] p-8 rounded-3xl min-h-[600px] flex flex-col justify-center">
    <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-16 items-center">
      <div>
        <div className="w-16 h-16 rounded-full bg-[#e0e5ec] shadow-[6px_6px_12px_#b8b9be,-6px_-6px_12px_#ffffff] flex items-center justify-center text-2xl mb-8">
          🚀
  ...
  </div>`} htmlCode={`<div class="bg-[#e0e5ec] p-8 rounded-3xl min-h-[600px] flex flex-col justify-center">
    <div class="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-16 items-center">
      <div>
        <div class="w-16 h-16 rounded-full bg-[#e0e5ec] shadow-[6px_6px_12px_#b8b9be,-6px_-6px_12px_#ffffff] flex items-center justify-center text-2xl mb-8">
          🚀
        </div>
        <h1 class="text-5xl font-bold text-slate-700 mb-6">Soft UI Design System</h1>
        <p class="text-slate-500 text-lg mb-10">
          Experience the tactile feel of neumorphism. Soft shadows, rounded corners, and a calming color palette.
        </p>
        <div class="flex gap-6">
          <button class="px-8 py-4 rounded-xl bg-[#e0e5ec] text-blue-600 font-bold shadow-[6px_6px_12px_#b8b9be,-6px_-6px_12px_#ffffff] hover:shadow-[inset_6px_6px_12px_#b8b9be,inset_-6px_-6px_12px_#ffffff] active:scale-95 transition-all">
            Get Started
          </button>
          <button class="px-8 py-4 rounded-xl bg-[#e0e5ec] text-slate-600 font-bold shadow-[inset_6px_6px_12px_#b8b9be,inset_-6px_-6px_12px_#ffffff] hover:shadow-[6px_6px_12px_#b8b9be,-6px_-6px_12px_#ffffff] transition-all">
            Learn More
          </button>
        </div>
      </div>
      ...
      <div class="relative">
        <div class="aspect-square rounded-[3rem] bg-[#e0e5ec] shadow-[20px_20px_60px_#b8b9be,-20px_-20px_60px_#ffffff] flex items-center justify-center p-12">
           <div class="w-full h-full rounded-2xl bg-[#e0e5ec] shadow-[inset_10px_10px_20px_#b8b9be,inset_-10px_-10px_20px_#ffffff] flex items-center justify-center">
             <span class="text-slate-400 font-bold text-xl">Interactive Preview</span>
           </div>
        </div>
      </div>
    </div>
  </div>`} cssCode={`/* LandingNeumorphic Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  border-radius: 0.75rem;\n  border-radius: 1.5rem;\n  border-radius: 1rem;\n  border-radius: 9999px;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #2563eb;\n  color: #334155;\n  color: #475569;\n  color: #64748b;\n  color: #94a3b8;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  height: 100%;\n  justify-content: center;\n  padding-left: 2rem; padding-right: 2rem;\n  padding-top: 1rem; padding-bottom: 1rem;\n  padding: 2rem;\n  padding: 3rem;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>

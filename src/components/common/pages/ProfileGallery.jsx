...
const ProfileGallery = () => {
  return (
    <div className="container box-shadow overflow-y-auto bg-slate-100 p-6 md:p-12 font-sans pb-40">
      ...
      <div className="space-y-32">
        ...
        <section className='box-shadow p-4 rounded-lg relative group/prof'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/prof:opacity-100 transition-opacity"><CopyButton jsxCode={`<svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>`} htmlCode={`<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>`} cssCode={`/* ProfileStandard Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  background-color: #2563eb;\n  background-color: #eff6ff;\n  background-color: #f8fafc;\n  background-color: #ffffff;\n  border-color: #2563eb;\n  border-color: #e5e7eb;\n  border-color: #f3f4f6;\n  border-color: #ffffff;\n  border-radius: 0.75rem;\n  border-radius: 1.5rem;\n  border-radius: 9999px;\n  border-width: 1px; border-style: solid;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #111827;\n  color: #16a34a;\n  color: #2563eb;\n  color: #4b5563;\n  color: #6b7280;\n  color: #9ca3af;\n  color: #ffffff;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  padding-left: 1.5rem; padding-right: 1.5rem;\n  padding-top: 0.5rem; padding-bottom: 0.5rem;\n  padding: 0.5rem;\n  padding: 1.5rem;\n  padding: 2rem;\n  text-align: center;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
        ...
        <section className='box-shadow p-4 rounded-lg relative group/prof'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/prof:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-white p-8 rounded-3xl border border-gray-100 max-w-4xl mx-auto">
    <header className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-12">
      <div className="w-32 h-32 md:w-40 md:h-40 rounded-full p-1 bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 flex-shrink-0">
        <img src={user.avatar} alt="Profile" className="w-full h-full rounded-full object-cover border-4 border-white" />
      </div>
  ...
  </div>`} htmlCode={`<div class="bg-white p-8 rounded-3xl border border-gray-100 max-w-4xl mx-auto">
    <header class="flex flex-col md:flex-row items-center md:items-start gap-8 mb-12">
      <div class="w-32 h-32 md:w-40 md:h-40 rounded-full p-1 bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 flex-shrink-0">
        <img src=... alt="Profile" class="w-full h-full rounded-full object-cover border-4 border-white" />
      </div>
      
      <div class="flex-1 text-center md:text-left">
        <div class="flex flex-col md:flex-row items-center gap-4 mb-4">
          <h2 class="text-2xl font-light text-gray-900">...</h2>
          <div class="flex gap-2">
            <button class="px-6 py-1.5 bg-gray-100 rounded-lg text-sm font-semibold hover:bg-gray-200">Follow</button>
            <button class="px-4 py-1.5 bg-gray-100 rounded-lg text-sm font-semibold hover:bg-gray-200">Message</button>
          </div>
        </div>
        
        <div class="flex justify-center md:justify-start gap-8 mb-4 text-sm">
          <span><strong class="text-gray-900">...</strong> posts</span>
          <span><strong class="text-gray-900">...</strong> followers</span>
          <span><strong class="text-gray-900">...</strong> following</span>
        </div>
        
        <div>
          <div class="font-bold text-gray-900">...</div>
          <p class="text-gray-600 whitespace-pre-line">...</p>
          <a href="#" class="text-blue-900 font-medium text-sm">bit.ly/alex-portfolio</a>
        </div>
      </div>
    </header>
    ...
    <div class="border-t border-gray-200 pt-8">
      <div class="grid grid-cols-3 gap-1 md:gap-4">
        ... class="aspect-square bg-gray-100 relative group overflow-hidden">
            <img src=https://images.unsplash.com/photo-\$...?q=80&w=300&auto=format&fit=crop class="w-full h-full object-cover" alt="" />
            <div class="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center text-white font-bold gap-4">
              <span>❤️ 1.2k</span>
            </div>
          </div>
        ))}
  ...
  </div>`} cssCode={`/* ProfileSocial Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  background-color: #f3f4f6;\n  background-color: #ffffff;\n  border-color: #e5e7eb;\n  border-color: #f3f4f6;\n  border-color: #ffffff;\n  border-radius: 0.5rem;\n  border-radius: 1.5rem;\n  border-radius: 9999px;\n  border-width: 1px; border-style: solid;\n  color: #111827;\n  color: #4b5563;\n  color: #ffffff;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  height: 100%;\n  justify-content: center;\n  padding-left: 1.5rem; padding-right: 1.5rem;\n  padding-left: 1rem; padding-right: 1rem;\n  padding-top: 0.25rem; padding-bottom: 0.25rem;\n  padding: 0.25rem;\n  padding: 2rem;\n  text-align: center;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
        ...
        <section className='box-shadow p-4 rounded-lg relative group/prof'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/prof:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-[#0d1117] text-[#c9d1d9] p-8 rounded-3xl border border-gray-800 max-w-5xl mx-auto font-mono">
    <div className="flex flex-col md:flex-row gap-8">
      <div className="w-full md:w-1/4">
        <img src={user.avatar} className="w-full aspect-square rounded-full border border-gray-700 mb-4" alt="" />
        <h1 className="text-2xl font-bold text-white">{user.name}</h1>
  ...
  </div>`} htmlCode={`<div class="bg-[#0d1117] text-[#c9d1d9] p-8 rounded-3xl border border-gray-800 max-w-5xl mx-auto font-mono">
    <div class="flex flex-col md:flex-row gap-8">
      <div class="w-full md:w-1/4">
        <img src=... class="w-full aspect-square rounded-full border border-gray-700 mb-4" alt="" />
        <h1 class="text-2xl font-bold text-white">...</h1>
        <p class="text-gray-400 text-lg mb-4">...</p>
        <p class="text-sm mb-6">...</p>
        <button class="w-full py-1.5 bg-[#21262d] border border-gray-600 rounded-md text-sm font-bold text-white hover:bg-gray-700 mb-6">Edit Profile</button>
        
        <div class="space-y-2 text-sm text-gray-400">
          <div class="flex items-center gap-2">🏢 TechFlow Inc.</div>
          <div class="flex items-center gap-2">📍 ...</div>
          <div class="flex items-center gap-2">🔗 alex.dev</div>
        </div>
      </div>
      
      <div class="w-full md:w-3/4">
        <div class="text-sm mb-2">Pinned Repositories</div>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          ... class="p-4 border border-gray-700 rounded-md bg-[#0d1117] hover:border-gray-500">
              <div class="flex items-center gap-2 mb-2 font-bold text-blue-400">
                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 16 16"><path d="M2 2.5A2.5 2.5 0 0 1 4.5 0h8.75a.75.75 0 0 1 .75.75v12.5a.75.75 0 0 1-.75.75h-2.5a.75.75 0 1 1 0-1.5h1.75v-2h-8a1 1 0 0 0-.714 1.7.75.75 0 0 1-1.072 1.05A2.495 2.495 0 0 1 2 11.5v-9zm10.5-1V9h-8c-.356 0-.694.074-1 .208V2.5a1 1 0 0 1 1-1h8zM5 12.25v3.25a.25.25 0 0 0 .4.2l1.45-1.087a.25.25 0 0 1 .3 0L8.6 15.7a.25.25 0 0 0 .4-.2v-3.25a.25.25 0 0 0-.25-.25h-3.5a.25.25 0 0 0-.25.25z"/></svg>
                <span>react-awesome-lib</span>
              </div>
              <p class="text-xs text-gray-400 mb-4">A lightweight library for building awesome interfaces.</p>
        ...
        <div class="text-sm mb-2">Contribution Activity</div>
        <div class="bg-[#0d1117] border border-gray-700 p-4 rounded-md">
  ...
  </div>`} cssCode={`/* ProfileDev Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  background-color: #facc15;\n  border-color: #1f2937;\n  border-color: #374151;\n  border-color: #4b5563;\n  border-radius: 1.5rem;\n  border-radius: 9999px;\n  border-width: 1px; border-style: solid;\n  color: #60a5fa;\n  color: #6b7280;\n  color: #9ca3af;\n  color: #ffffff;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  padding-top: 0.25rem; padding-bottom: 0.25rem;\n  padding: 1rem;\n  padding: 2rem;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
        ...
        <section className='box-shadow p-4 rounded-lg relative group/prof'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/prof:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="relative h-[600px] w-full rounded-3xl overflow-hidden bg-gradient-to-br from-pink-500 via-purple-500 to-indigo-500 flex items-center justify-center p-4">
    <div className="absolute top-20 right-20 w-72 h-72 bg-yellow-300 rounded-full mix-blend-overlay filter blur-3xl opacity-50 animate-blob"></div>
    <div className="absolute bottom-20 left-20 w-72 h-72 bg-cyan-300 rounded-full mix-blend-overlay filter blur-3xl opacity-50 animate-blob"></div>
  ...
  </div>`} htmlCode={`<div class="relative h-[600px] w-full rounded-3xl overflow-hidden bg-gradient-to-br from-pink-500 via-purple-500 to-indigo-500 flex items-center justify-center p-4">
    <div class="absolute top-20 right-20 w-72 h-72 bg-yellow-300 rounded-full mix-blend-overlay filter blur-3xl opacity-50 animate-blob"></div>
    <div class="absolute bottom-20 left-20 w-72 h-72 bg-cyan-300 rounded-full mix-blend-overlay filter blur-3xl opacity-50 animate-blob"></div>

    <div class="relative bg-white/20 backdrop-blur-xl border border-white/30 p-12 rounded-[3rem] shadow-2xl w-full max-w-lg text-center text-white">
      <div class="relative inline-block mb-6">
        <img src=... alt="Profile" class="w-32 h-32 rounded-full object-cover border-4 border-white/50 shadow-lg" />
        <div class="absolute bottom-1 right-1 w-6 h-6 bg-green-400 border-2 border-white rounded-full"></div>
      </div>
      
      <h2 class="text-4xl font-bold mb-2 drop-shadow-md">...</h2>
      <p class="text-white/80 font-medium mb-8 uppercase tracking-widest text-sm">...</p>
      
      <div class="flex justify-center gap-12 mb-10 border-y border-white/20 py-6">
        <div>
          <div class="text-2xl font-bold">128</div>
          <div class="text-xs uppercase opacity-70">Projects</div>
        </div>
        <div>
          <div class="text-2xl font-bold">4.2k</div>
          <div class="text-xs uppercase opacity-70">Likes</div>
        </div>
        <div>
          <div class="text-2xl font-bold">850</div>
          <div class="text-xs uppercase opacity-70">Followers</div>
        </div>
      </div>
      
      <div class="space-y-4">
        <button class="w-full py-3 bg-white text-purple-600 font-bold rounded-xl shadow-lg hover:scale-105 transition-transform">
          View Portfolio
        </button>
        <button class="w-full py-3 bg-transparent border-2 border-white/50 text-white font-bold rounded-xl hover:bg-white/10 transition-colors">
          Contact Me
        </button>
      </div>
    </div>
  </div>`} cssCode={`/* ProfileGlass Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  backdrop-filter: blur(12px);\n  background-color: #fde047;\n  background-color: #ffffff;\n  background-color: transparent;\n  border-color: #ffffff;\n  border-radius: 0.75rem;\n  border-radius: 1.5rem;\n  border-radius: 9999px;\n  border-width: 1px; border-style: solid;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #9333ea;\n  color: #ffffff;\n  display: flex;\n  font-weight: 700;\n  justify-content: center;\n  padding-top: 0.75rem; padding-bottom: 0.75rem;\n  padding-top: 1.5rem; padding-bottom: 1.5rem;\n  padding: 1rem;\n  padding: 3rem;\n  text-align: center;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 04. Glassmorphism </span>
          <ProfileGlass />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/prof'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/prof:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-slate-100 flex items-center justify-center h-[600px] rounded-3xl">
    <div className="bg-white w-full max-w-2xl rounded-2xl shadow-xl overflow-hidden flex">
      {/* Left Stripe */}
      <div className="w-4 bg-blue-800"></div>
  ...
  </div>`} htmlCode={`<div class="bg-slate-100 flex items-center justify-center h-[600px] rounded-3xl">
    <div class="bg-white w-full max-w-2xl rounded-2xl shadow-xl overflow-hidden flex">
      ...
      <div class="w-4 bg-blue-800"></div>
      
      <div class="flex-1 p-8 md:p-12">
        <div class="flex justify-between items-start mb-8">
          <div class="text-2xl font-bold text-slate-800 tracking-tight">TechCorp<span class="text-blue-600">.</span></div>
          <div class="w-16 h-16 bg-slate-100 rounded-lg flex items-center justify-center">
             ...
             <div class="w-10 h-10 border-2 border-black border-dashed opacity-20"></div>
          </div>
        </div>
        
        <div class="flex items-center gap-8 mb-10">
          <img src=... class="w-32 h-32 rounded-lg object-cover shadow-md" alt="" />
          <div>
            <h1 class="text-3xl font-bold text-slate-900">...</h1>
            <p class="text-blue-600 font-medium text-lg mb-2">...</p>
            <p class="text-slate-500 text-sm">ID: 8842-1920</p>
            <div class="mt-2 inline-block px-3 py-1 bg-green-100 text-green-700 text-xs font-bold uppercase rounded-full">Active Employee</div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-6 border-t border-slate-100 pt-8">
          <div>
            ...
            <span class="text-slate-700 font-medium">Product Design</span>
          </div>
          <div>
            <span class="block text-xs font-bold text-slate-400 uppercase">Location</span>
            <span class="text-slate-700 font-medium">San Francisco HQ</span>
          </div>
          <div>
            <span class="block text-xs font-bold text-slate-400 uppercase">Email</span>
            <span class="text-slate-700 font-medium">alex@techcorp.com</span>
          </div>
          <div>
            <span class="block text-xs font-bold text-slate-400 uppercase">Phone</span>
            <span class="text-slate-700 font-medium">+1 (555) 019-2834</span>
          </div>
        </div>
      </div>
    </div>
  </div>`} cssCode={`/* ProfileCorporate Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  background-color: #f1f5f9;\n  background-color: #ffffff;\n  border-color: #000000;\n  border-color: #f1f5f9;\n  border-radius: 0.5rem;\n  border-radius: 1.5rem;\n  border-radius: 1rem;\n  border-radius: 9999px;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #0f172a;\n  color: #1e293b;\n  color: #2563eb;\n  color: #334155;\n  color: #64748b;\n  color: #94a3b8;\n  display: flex;\n  font-weight: 700;\n  justify-content: center;\n  justify-content: space-between;\n  padding-left: 0.75rem; padding-right: 0.75rem;\n  padding-top: 0.25rem; padding-bottom: 0.25rem;\n  padding: 2rem;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
        ...
        <section className='box-shadow p-4 rounded-lg relative group/prof'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/prof:opacity-100 transition-opacity"><CopyButton jsxCode={`<svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>`} htmlCode={`<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>`} cssCode={`/* ProfileCover Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  backdrop-filter: blur(12px);\n  background-color: #22c55e;\n  background-color: #2563eb;\n  background-color: #e5e7eb;\n  background-color: #f9fafb;\n  background-color: #ffffff;\n  border-color: #e5e7eb;\n  border-color: #ffffff;\n  border-radius: 0.5rem;\n  border-radius: 0.75rem;\n  border-radius: 1.5rem;\n  border-radius: 9999px;\n  border-width: 1px; border-style: solid;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #111827;\n  color: #2563eb;\n  color: #374151;\n  color: #4b5563;\n  color: #6b7280;\n  color: #ffffff;\n  display: flex;\n  font-weight: 700;\n  height: 100%;\n  justify-content: space-between;\n  padding-left: 1.5rem; padding-right: 1.5rem;\n  padding-left: 1rem; padding-right: 1rem;\n  padding-left: 2rem; padding-right: 2rem;\n  padding-top: 0.5rem; padding-bottom: 0.5rem;\n  padding: 1.5rem;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
        ...
        <section className='box-shadow p-4 rounded-lg relative group/prof'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/prof:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-black p-1 border-2 border-purple-600 rounded-3xl max-w-4xl mx-auto shadow-[0_0_20px_rgba(147,51,234,0.3)]">
    <div className="bg-gray-900 h-full rounded-[20px] p-8 overflow-hidden relative">
      {/* Background Grid */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(147,51,234,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(147,51,234,0.1)_1px,transparent_1px)] bg-[size:40px_40px]"></div>
  ...
  </div>`} htmlCode={`<div class="bg-black p-1 border-2 border-purple-600 rounded-3xl max-w-4xl mx-auto shadow-[0_0_20px_rgba(147,51,234,0.3)]">
    <div class="bg-gray-900 h-full rounded-[20px] p-8 overflow-hidden relative">
      ...
      <div class="absolute inset-0 bg-[linear-gradient(rgba(147,51,234,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(147,51,234,0.1)_1px,transparent_1px)] bg-[size:40px_40px]"></div>
      
      <div class="relative z-10 flex flex-col md:flex-row gap-8 items-center md:items-start">
        <div class="relative">
          <div class="w-40 h-40 rounded-full p-1 bg-gradient-to-b from-purple-500 to-cyan-500">
            <img src=... class="w-full h-full rounded-full object-cover grayscale contrast-125" alt="" />
          </div>
          <div class="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-black border border-purple-500 text-purple-400 px-3 py-1 text-xs font-mono font-bold uppercase tracking-widest whitespace-nowrap">
            LVL 42
          </div>
        </div>
        
        <div class="flex-1 text-center md:text-left">
          <h2 class="text-3xl font-black text-white italic tracking-wider mb-1 uppercase" style=...}>
            ...
          </h2>
          <p class="text-cyan-400 font-mono text-sm mb-6">> ...</p>
          
          <div class="flex flex-wrap justify-center md:justify-start gap-4 mb-8">
            ... class="px-3 py-1 bg-purple-900/30 border border-purple-500/50 text-purple-300 text-xs font-mono">
                [...]
              </span>
            ))}
          </div>
          
          <div class="grid grid-cols-3 gap-2 bg-black/50 p-4 border border-gray-800 rounded-lg max-w-md mx-auto md:mx-0">
            <div class="text-center">
              <div class="text-xs text-gray-500 uppercase">Rank</div>
              <div class="text-xl font-bold text-white">#04</div>
            </div>
            <div class="text-center border-l border-gray-800">
              <div class="text-xs text-gray-500 uppercase">K/D Ratio</div>
              <div class="text-xl font-bold text-white">2.4</div>
            </div>
            <div class="text-center border-l border-gray-800">
              <div class="text-xs text-gray-500 uppercase">Matches</div>
              <div class="text-xl font-bold text-white">842</div>
            </div>
          </div>
        </div>
      </div>
    </div>
  </div>`} cssCode={`/* ProfileCyber Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  background-color: #000000;\n  background-color: #111827;\n  border-color: #1f2937;\n  border-color: #9333ea;\n  border-color: #a855f7;\n  border-radius: 0.5rem;\n  border-radius: 1.5rem;\n  border-radius: 9999px;\n  border-width: 1px; border-style: solid;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #6b7280;\n  color: #c084fc;\n  color: #ffffff;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  height: 100%;\n  justify-content: center;\n  padding-left: 0.75rem; padding-right: 0.75rem;\n  padding-top: 0.25rem; padding-bottom: 0.25rem;\n  padding: 0.25rem;\n  padding: 1rem;\n  padding: 2rem;\n  text-align: center;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 07. Cyberpunk Gamer </span>
          <ProfileCyber />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/prof'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/prof:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-white flex justify-center py-12 rounded-3xl border border-gray-100">
    <div className="w-full max-w-sm px-6 text-center">
      <img src={user.avatar} className="w-24 h-24 rounded-full mx-auto mb-4 object-cover shadow-lg" alt="" />
      <h2 className="text-xl font-bold text-gray-900">@{user.handle.replace('@','')}</h2>
      <p className="text-gray-500 text-sm mb-8">{user.bio}</p>
  ...
  </div>`} htmlCode={`<div class="bg-white flex justify-center py-12 rounded-3xl border border-gray-100">
    <div class="w-full max-w-sm px-6 text-center">
      <img src=... class="w-24 h-24 rounded-full mx-auto mb-4 object-cover shadow-lg" alt="" />
      ...
      <div class="space-y-4">
        ...,
          ...
          <a key=... href="#" class="block bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-xl p-4 transition-all hover:-translate-y-1 hover:shadow-md">
            <div class="font-bold text-gray-900">...</div>
      ...
      <div class="flex justify-center gap-6 mt-12 text-2xl text-gray-400">
        <a href="#" class="hover:text-gray-800 hover:scale-110 transition-all">🐦</a>
        <a href="#" class="hover:text-gray-800 hover:scale-110 transition-all">📸</a>
        <a href="#" class="hover:text-gray-800 hover:scale-110 transition-all">💼</a>
      </div>
    </div>
  </div>`} cssCode={`/* ProfileLinkTree Styles (Generated from Tailwind) */\n.component-root {\n  background-color: #f9fafb;\n  background-color: #ffffff;\n  border-color: #e5e7eb;\n  border-color: #f3f4f6;\n  border-radius: 0.75rem;\n  border-radius: 1.5rem;\n  border-radius: 9999px;\n  border-width: 1px; border-style: solid;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #111827;\n  color: #6b7280;\n  color: #9ca3af;\n  display: flex;\n  font-weight: 700;\n  justify-content: center;\n  padding-left: 1.5rem; padding-right: 1.5rem;\n  padding-top: 3rem; padding-bottom: 3rem;\n  padding: 1rem;\n  text-align: center;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
        ...
        <section className='box-shadow p-4 rounded-lg relative group/prof'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/prof:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-[#e0e5ec] p-12 rounded-3xl flex justify-center">
    <div className="w-full max-w-md bg-[#e0e5ec] p-10 rounded-[3rem] shadow-[20px_20px_60px_#bebebe,-20px_-20px_60px_#ffffff] text-center">
      <div className="w-32 h-32 mx-auto rounded-full p-2 bg-[#e0e5ec] shadow-[inset_5px_5px_10px_#bebebe,inset_-5px_-5px_10px_#ffffff] mb-8">
        <img src={user.avatar} className="w-full h-full rounded-full object-cover" alt="" />
      </div>
  ...
  </div>`} htmlCode={`<div class="bg-[#e0e5ec] p-12 rounded-3xl flex justify-center">
    <div class="w-full max-w-md bg-[#e0e5ec] p-10 rounded-[3rem] shadow-[20px_20px_60px_#bebebe,-20px_-20px_60px_#ffffff] text-center">
      <div class="w-32 h-32 mx-auto rounded-full p-2 bg-[#e0e5ec] shadow-[inset_5px_5px_10px_#bebebe,inset_-5px_-5px_10px_#ffffff] mb-8">
        <img src=... class="w-full h-full rounded-full object-cover" alt="" />
      </div>
      
      <h2 class="text-2xl font-bold text-gray-700 mb-2">...</h2>
      <p class="text-gray-500 text-sm mb-8">...</p>
      
      <div class="flex justify-center gap-8 mb-10">
        <div class="flex flex-col items-center">
          <div class="font-bold text-gray-700 text-xl">24</div>
          <div class="text-xs text-gray-500">Shots</div>
        </div>
        <div class="w-px h-10 bg-gray-300"></div>
        <div class="flex flex-col items-center">
          <div class="font-bold text-gray-700 text-xl">1.2k</div>
          <div class="text-xs text-gray-500">Followers</div>
        </div>
        <div class="w-px h-10 bg-gray-300"></div>
        <div class="flex flex-col items-center">
          <div class="font-bold text-gray-700 text-xl">842</div>
          <div class="text-xs text-gray-500">Following</div>
        </div>
      </div>
      
      <div class="flex gap-4">
        <button class="flex-1 py-3 rounded-xl bg-[#e0e5ec] text-blue-500 font-bold shadow-[5px_5px_10px_#bebebe,-5px_-5px_10px_#ffffff] hover:shadow-[inset_5px_5px_10px_#bebebe,inset_-5px_-5px_10px_#ffffff] active:scale-95 transition-all">
          Follow
        </button>
        <button class="flex-1 py-3 rounded-xl bg-[#e0e5ec] text-gray-600 font-bold shadow-[5px_5px_10px_#bebebe,-5px_-5px_10px_#ffffff] hover:shadow-[inset_5px_5px_10px_#bebebe,inset_-5px_-5px_10px_#ffffff] active:scale-95 transition-all">
          Message
        </button>
      </div>
    </div>
  </div>`} cssCode={`/* ProfileNeumorphic Styles (Generated from Tailwind) */\n.component-root {\n  align-items: center;\n  border-radius: 0.75rem;\n  border-radius: 1.5rem;\n  border-radius: 9999px;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #374151;\n  color: #3b82f6;\n  color: #4b5563;\n  color: #6b7280;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  height: 100%;\n  justify-content: center;\n  padding-top: 0.75rem; padding-bottom: 0.75rem;\n  padding: 0.5rem;\n  padding: 2.5rem;\n  padding: 3rem;\n  text-align: center;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>
          <span className="text-xs font-bold text-slate-400 uppercase tracking-widest block text-center mb-6"> 09. Neumorphic </span>
          <ProfileNeumorphic />
        </section>

        <section className='box-shadow p-4 rounded-lg relative group/prof'>
          <div className="absolute top-2 right-2 z-40 opacity-0 group-hover/prof:opacity-100 transition-opacity"><CopyButton jsxCode={`<div className="bg-yellow-400 p-8 rounded-3xl border-4 border-black max-w-4xl mx-auto shadow-[12px_12px_0_0_#000]">
    <div className="flex flex-col md:flex-row gap-8">
      <div className="w-full md:w-1/3">
        <div className="aspect-square border-4 border-black mb-4 overflow-hidden bg-white">
          <img src={user.avatar} className="w-full h-full object-cover filter contrast-125 hover:scale-110 transition-transform duration-300" alt="" />
  ...
  </div>`} htmlCode={`<div class="bg-yellow-400 p-8 rounded-3xl border-4 border-black max-w-4xl mx-auto shadow-[12px_12px_0_0_#000]">
    <div class="flex flex-col md:flex-row gap-8">
      <div class="w-full md:w-1/3">
        <div class="aspect-square border-4 border-black mb-4 overflow-hidden bg-white">
          <img src=... class="w-full h-full object-cover filter contrast-125 hover:scale-110 transition-transform duration-300" alt="" />
        </div>
        <button class="w-full py-3 bg-black text-white font-black text-xl uppercase hover:bg-white hover:text-black border-4 border-transparent hover:border-black transition-colors">
          Hire Me
        </button>
      </div>
      
      <div class="w-full md:w-2/3 bg-white border-4 border-black p-8">
        <h1 class="text-5xl font-black uppercase leading-none mb-4">...</h1>
        <div class="inline-block bg-black text-white px-3 py-1 font-bold uppercase mb-6">...</div>
        
        <p class="font-bold text-xl mb-8 leading-tight">
          "I design interfaces that make people stop scrolling and start clicking."
        </p>
        
        <div class="space-y-4">
          <div class="border-b-4 border-black pb-2 flex justify-between items-end font-bold">
            <span>SKILL_01</span>
            <span>UI DESIGN</span>
          </div>
          <div class="border-b-4 border-black pb-2 flex justify-between items-end font-bold">
  ...
  </div>`} cssCode={`/* ProfileBrutalist Styles (Generated from Tailwind) */\n.component-root {\n  background-color: #000000;\n  background-color: #facc15;\n  background-color: #ffffff;\n  border-color: #000000;\n  border-color: transparent;\n  border-radius: 1.5rem;\n  box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);\n  color: #ffffff;\n  display: flex;\n  flex-direction: column;\n  font-weight: 700;\n  height: 100%;\n  justify-content: space-between;\n  padding-left: 0.75rem; padding-right: 0.75rem;\n  padding-top: 0.25rem; padding-bottom: 0.25rem;\n  padding-top: 0.75rem; padding-bottom: 0.75rem;\n  padding: 2rem;\n  width: 100%;\n}\n\n/* Note: This conversion covers core layout and colors. \n   Check HTML/JSX tabs for full structural details. */`} /></div>

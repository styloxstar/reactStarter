...
function AppContent() {
  ...
  return (
    <div className="min-h-screen bg-[hsl(var(--background))] text-[hsl(var(--foreground))] transition-colors duration-300 overflow-x-hidden">
      ...
      <aside className={`fixed top-0 left-0 z-50 h-full w-72 bg-[hsl(var(--background))] glass-card shadow-2xl transition-transform duration-300 ease-in-out md:hidden ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
